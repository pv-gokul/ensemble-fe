  ...
  return (
    <div className="workflow-test">
      ...
      <div className="input-output">
        ...
        <div className="component output relative">
          <div>Output</div>
          {isLoading ? (
            <svg
              aria-hidden="true"
              className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 absolute top-0 bottom-0 left-0 right-0 mx-auto my-auto"
              viewBox="0 0 100 101"
              fill="none"
